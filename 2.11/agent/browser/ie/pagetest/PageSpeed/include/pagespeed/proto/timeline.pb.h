...
const InstrumentationData_RecordType InstrumentationData_RecordType_RecordType_MAX = InstrumentationData_RecordType_TIME_STAMP;
...
class InstrumentationData_DataDictionary : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_is_main_resource() const;
  inline void clear_is_main_resource();
  static const int kIsMainResourceFieldNumber = 17;
  inline bool is_main_resource() const;
  inline void set_is_main_resource(bool value);
  ...
  inline bool has_expected_content_length() const;
  inline void clear_expected_content_length();
  static const int kExpectedContentLengthFieldNumber = 20;
  inline ::google::protobuf::int32 expected_content_length() const;
  inline void set_expected_content_length(::google::protobuf::int32 value);
