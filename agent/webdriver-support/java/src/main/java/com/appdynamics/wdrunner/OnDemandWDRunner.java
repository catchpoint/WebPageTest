...
public class OnDemandWDRunner {
    ...
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        RemoteWebDriver webDriver = new RemoteWebDriver(
            new MockExecutor(new HttpCommandExecutor(new URL("http://localhost:7055/hub")),
                new SessionId("6ff0f704-f216-4199-8a8b-bdc908c12f7a")),
    ...
    private static class MockExecutor implements CommandExecutor {
        private HttpCommandExecutor commandExecutor;
        private SessionId sessionId;

        public MockExecutor(HttpCommandExecutor executor, SessionId sessionId) {
        ...
        public Response execute(Command command) throws IOException {
            ...
            Command proxyCommand = new Command(sessionId, command.getName(), command.getParameters());
            return commandExecutor.execute(proxyCommand);
        }
    }
}
