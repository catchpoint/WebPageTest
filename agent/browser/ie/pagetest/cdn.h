...
CDN_PROVIDER cdnList[] = {
	...
	{"youtube.", _T("Google")},
	{".who.is/whois/googlesyndicaton.com", _T("Google")},
	{"googlehosted.com", _T("Google")},
	{"alibabacloud.com", _T("Google")},
        {".doubleclick.net", _T("Google")},
	{".maxcdn.com",  _T("MaxCND")},
	{".whois.com", _T("Cotendo CDN")},
	...
	{".who.is/whois/gccdn.net", _T("CDNetworks")},
	{".fastly.com", _T("Fastly")},
	{".fastlylb.net", _T("Fastly")},
	{".nocookie.net", _T("Fastly")},
	{".nocookie.com", _T("Fastly")},
