  ...
  <table align="center">
    ...
    <tr>
      ...
      <td><select name="runtouseforaverage" id="runtouseforaverage">
        <option value="0" {if $job.RunToUseForAverage eq 0}selected="true" {/if}>Average</option>
        <option value="1" {if $job.RunToUseForAverage eq 1}selected="true" {/if}>1</option>
        <option value="2" {if $job.RunToUseForAverage eq 2}selected="true" {/if}>2</option>
        <option value="3" {if $job.RunToUseForAverage eq 3}selected="true" {/if}>3</option>
      </select></td>
    </tr>
    <tr>
