...
(function(d) {
    ...
    d.modal.impl = {
        ...
        init: function(a, b) {
            ...
            } else if (typeof a === "string" || typeof a === "number") a =
                d("<div></div>").html(a);
            else {
        ...
        setContainerDimensions: function() {
            var a = this,
                b = a.d.origHeight ? a.d.origHeight : d.browser.opera ? a.d.container.height() : a.getVal(a.d.container.css("height"), "h"),
                c = a.d.origWidth ? a.d.origWidth : d.browser.opera ? a.d.container.width() : a.getVal(a.d.container.css("width"), "w"),
                h = a.d.data.outerHeight(true),
            ...
            b = b ? a.o.autoResize && b > e ? e : b : h ? h > e ? e : a.o.minHeight && j !== "auto" && h < j ? j : h : j;
            e = a.o.minWidth ? a.getVal(a.o.minWidth, "w") : "auto";
            c = c ? a.o.autoResize && c > i ? i : c : g ? g > i ? i : a.o.minWidth && e !== "auto" && g < e ? e : g : e;
            a.d.container.css({
                height: b,
                width: c
            });
