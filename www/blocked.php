      ...
      <?php
        ...
        <main>
          <div class="translucent">
              ...
              <?php if (GetSetting('contact')) {
                    echo '<br><br>If there is a site you want tested that was blocked, please <a href="mailto:' . GetSetting('contact') . '">contact us</a>' . ' and send us your IP address (below) and URL that you are trying to test';
              } ?>.</p>
              <p>
