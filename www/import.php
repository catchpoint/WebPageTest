      ...
      ****************************************************************************/
        ...
        if (isset($_REQUEST['test']) && strlen($_REQUEST['test']) && ValidateTestId($_REQUEST['test'])) {
            ...
            if ($test) {
                ...
                $run = $test['runs'];
                if (
                    ((array_key_exists('key', $test) && strlen($test['key'])) ||
        ...
        if (!isset($error)) {
          // move the dev tools file over
            if (
                array_key_exists('devtools', $_FILES) &&
          ...
          // screenshot (if we got one)
            if (
                array_key_exists('screenshot', $_FILES) &&
          ...
          // pcap
            if (
                array_key_exists('tcpdump', $_FILES) &&
          ...
          // custom metrics
            if (
                array_key_exists('metrics', $_REQUEST) &&
