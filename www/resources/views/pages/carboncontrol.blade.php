                    ...
                    <div class="form_clip">
                        ...
                        <div class="ei_diagnostics ei_diagnostics-context">
                            ...
                            @endif 
                                ...
                                <li>
                                    <span>A site's carbon footprint can vary greatly by device and location, particularly if it relies on 3rd party advertising. <a href="/?url={{ $test_url }}">Test this site from another country</a> to see how its footprint varies.</span>
