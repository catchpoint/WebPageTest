                    ...
                    <p>Enter multiple urls to compare them against each other visually.</p>
                        ...
                        <div id="urls">
                            ...
                            <div id="urldiv1" class="urldiv">
                                Label: <input id="label1" type="text" name="label[1]" style="width:10em" onfocus="if (this.value == this.defaultValue) {this.value = '';}" onblur="if (this.value == '') {this.value = this.defaultValue;}"> 
                                URL: <input id="url1" type="text" name="url[1]" style="width:30em" onfocus="if (this.value == this.defaultValue) {this.value = '';}" onblur="if (this.value == '') {this.value = this.defaultValue;}" onkeypress="if (event.keyCode == 32) {return false;}" > 
