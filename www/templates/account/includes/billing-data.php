...
<div class="card api-consumers">
    ...
    <div class="info">
        <form method='POST' action='/account'>
            <table class="sortable api-table">
                <caption>
                            ...
                            <td class="hidden-content api-key">
                                <div tabindex="0" class="ellipsis-menu">
                                    ...
                                    <div class="ellipsis-menu-dropdown">
                                        <a class="regenerate-key" href="javascript:alert('Dropdown 1')">Regenerate API key</a>
                                        <a class="delete-key" href="javascript:alert('Dropdown 2')">Delete</a>
