...
$is_pro = !is_null($user) ? $user->isPaid() : false;
$is_free = !is_null($user) ? $user->isFree() : false;
$show_new_ui_activation_button = Util::getSetting('cp_portal_url') && (
    ($is_pro && Util::getSetting('cp_portal_enable_pro')) || ($is_free && Util::getSetting('cp_portal_enable_free'))
);
...
<wpt-header>
    ...
    <header>
        <div class="wptheader_logo_container">
            <p class="wptheader_logo">
                <a href="https://www.catchpoint.com/platform">Platform</a>
                <a href="/">WebPageTest</a>
            </p>
            <p>
                <?php if ($show_new_ui_activation_button): ?>
                    <a class="pill" id="new_experience" onclick="OpenNewPortalDialog();">
                        Enable New UI
                    </a>
                <?php endif; ?>
            </p>
            <div id='new-portal-dialog' style='display:none;'>
                <div class='dialog-title'>
                    <div>
                        Preview our new WebPageTest Portal!
                    </div>
                ...
                <div class='dialog-body'>
                    <p>
                        We're transitioning WebPageTest.org to a new portal.
                    </p>
                    <p>
                        Confirm your choice to dive into the enhanced design and explore the exciting new features.
                    </p>
                    <p>
                        Enjoy a fresh and improved experience that elevates your workflow!
                    </p>
                </div>
                <div class='dialog-footer'>
                    <a class='pill' href='/enable_portal.php'>
                        Enable
                    </a>
                </div>
            </div>
                                ...
                                <div class="wptheader_nav_menu_content">
                                    ...
                                    <div class="wptheader_nav_menu_section">
                                        ...
                                        <ul class="wptheader_nav_menu_linkgrid">
                                            ...
                                            <li class="wptheader_nav_menu_link"><img src="/assets/images/github.svg" alt=""><a href="https://github.com/catchpoint/WebPageTest">Github</a></li>
                                        </ul>
                                    </div>
                                </div>
                        </details>
