...
$data = loadPageRunData($testPath, $run, $cached, $options, $beer_data);//BEER
    ...
    <body>
        <div class="page">
            ...
            <div id="result">
                ...
                $secure = false;
                $haveLocations = false;
                $requests = getRequests($id, $testPath, $run, @$_GET['cached'], $secure, $haveLocations, true, true, $beer_data);//BEER
                ?>
