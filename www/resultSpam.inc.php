    ...
    <body>
        <div class="page">
            ...
            <div class="translucent">
                ...
                <p><?php if($settings['contact']) echo 'If there is a site you want tested which was blocked, please <a href="mailto:' . $settings['contact'] . '">contact us</a>'. ' and send us your IP address (below) and URL that you are trying to test'; ?>.</p>
                <p>
