...
<html lang="en-us">
    ...
    <body>
            ...
            <div class="box">
                ...
                <p><?php if (GetSetting('contact')) {
                    echo 'If there is a site you want tested which was blocked, please <a href="mailto:' . GetSetting('contact') . '">contact us</a>' . ' and send us your IP address (below) and URL that you are trying to test';
                   } ?>.</p>
                <p>
