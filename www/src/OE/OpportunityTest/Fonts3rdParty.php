...
class Fonts3rdParty implements OpportunityTest
{
            ...
            $opp = new TestResult([
              ...
              "experiments" =>  array(
                (object) [
                    ...
                    "desc" => '<p>This experiment will fetch specified files server-side and reference them on the' .
                              ' same domain.  Note: the overrides happen at the host level, so any requests from' .
                              ' that host will now be self-hosted.</p>',
                ...
                (object) [
                    ...
                    "desc" => '<p>This experiment will add a <code>link</code> with <code>rel="preconnect"</code>' .
                              ' for specified hosts, which saves time for those steps when the resource is later' .
                              ' requested.</p>',
                ...
                (object) [
                    ...
                    "desc" => '<p>This experiment will add a <code>link</code> with <code>rel="preload"</code> for' .
                              ' specified hosts, causing the browser to fetch the file early and at a high' .
                              ' priority.</p>',
                    "expvar" => 'addpreload',
                ...
                (object) [
                    ...
                    "desc" => '<p>This experiment directs specified hosts to WebPageTest\'s blackhole server, which' .
                              ' will hang indefinitely until timing out. Use this experiment to test your site\'s' .
                              ' ability to display fallback text if fonts do not load quickly.</p>',
